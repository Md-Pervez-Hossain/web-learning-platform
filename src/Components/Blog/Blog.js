...
const Blog = () => {
  return (
    <div className="md:w-2/5 mx-auto py-16 px-4">
      ...
      <br />
      <h2 className="text-2xl font-bold">How does the private route work?</h2>
      <br />
      <p>
